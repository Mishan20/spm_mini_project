...
$id = $_SESSION['ID'];
//require_once('db.php');
$query = "select * from vehicle_booking WHERE user_id = $id;";
...
<body>
            ...
            <div style="margin-top: 50px;">
                ...
                <div style="margin-top: 10px;">
                    <button class="btn btn-lg btn-light x" style="width: 200px;text-align: left;"><i
                        class="bi bi-vinyl-fill p-1"></i><a href="Records.php">RECORDS</a></button>
                </div>
                <div style="margin-top: 10px;">
                    <button class="btn btn-lg btn-light " style="width: 200px;text-align: left;"><i
    ...
    <div  class = "form-horizontal  col-md-9" width="100%" height="5px" cellspacing="0"    style="margin-top: 170px; margin-left: -90px;"   >
        <div class="row mt-2">
            <div class="col">
                <div class="card mt-2">
                    <div class="card-header bg-danger"  >
                        <h2 class="display-6 text-center text-white" style="width: 100%;" > Booking Records</h2>
                    </div>
                    ...
                    <div class="card-body" >
                        <table class="table table-border text-center"  style="table-layout:fixed;" >
                            ...
                            <td class= "bg-dark text-white"style="width:10%">Name</td>
                                ...
                                <td class= "bg-dark text-white" style="width:12%">Approval</td>
                            ...
                            ?>
                                ...
                                <td ><a class= "btn" id="sts<?php echo $row['id'];?>"><?php echo $row['status'];?></a></td>
    ...
    $('[id^="sts"]').each(function() {
    
    if(this.innerHTML == "Pending"){
        $(this).css('background-color', 'orange');
        $(this).css('color', 'white');
    }else if(this.innerHTML == "Approved"){
