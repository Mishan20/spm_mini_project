...
//require_once('db.php');
$query = "select * from vehicle_booking WHERE status = 'Approved' OR status = 'Reject' ";
            ...
            <div class="col">
                <div class="card mt-2">
                    <div class="card-header bg-danger"  >
                        <h2 class="display-6 text-center text-white" style="width: 100%;"> Aproved Bookings</h2>
                    </div>
